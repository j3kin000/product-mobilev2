...
const FormsPageBasic = (props: any) => {
    ...
    return (
        <SafeAreaView style={styles.container}>
            {
                showAlert ? <View style={styles.lottieWrapper}>
                    {
            ...
            <View style={styles.header}>
                <TouchableOpacity style={styles.arrowBackWrapper} onPress={() => {
                    navigation.goBack()
                }}>
            ...
            <View style={{ flex: 1 }}>
                ...
                >
                    {
                        checker ? components : <Text style={styles.noForm}>{t('noFormElements')}</Text>
                    }
                </ScrollView>
...
export const InfoPage = (props) => <FormProvider><FormsPageBasic {...props} /></FormProvider>
