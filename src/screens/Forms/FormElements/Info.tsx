...
export const Info = (props: any) => {
  const {label, inputType, key, value, imgFromAmazon} = props.itemData;
  ...
  switch (inputType) {
    ...
    case 'cameraButton':
      return Array.isArray(imgFromAmazon) ? (
        <View style={styles.container}>
          <View style={styles.itemInfoWrapper}>
            <View style={styles.content}>
              <Text style={styles.label}>{label}:</Text>
              ...
              return (
                <View>
                  <ImageBackground
                    ...
                    source={require('../../../assets/defImage.png')}>
                    <Image
                      style={styles.photoMinify}
                      source={{uri: img}}
                      key="{img}"
