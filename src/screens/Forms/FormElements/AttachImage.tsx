...
export const AttachImage = React.forwardRef((props: any, ref) => {
    ...
    const pickImage = async () => {
        ...
        ImagePicker.openPicker({
            ...
            for (let img in images) {
                let filename = images[img].path.replace('file:///storage/emulated/0/Android/data/com.milgamproduct/cache/temp/', '')
    ...
    return (
        <View style={styles.container} ref={ref}>
            <Text style={{ color: 'black', marginBottom: scale(10) }}>{label ? label : null}</Text>
            <TouchableOpacity style={styles.btn} onPress={pickImage}>
                <Image style={styles.ico} source={require('../../../assets/attach-image.png')} />
