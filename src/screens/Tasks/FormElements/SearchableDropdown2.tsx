...
export const SearchDropdown2 = (props: any) => {
    ...
    return (
        <View style={styles.container} zIndex={2000}>
            ...
            {open ? <View style={styles.expandedPanel}>
                <ScrollView>
                    <TextInput style={styles.textInput} placeholder="Search here..." onChangeText={setChangeText} value={changeText} />

                    {
                        itemsToShow.map((item, index) => {
                            return (<TouchableOpacity style={styles.singleItem} onPress={() => {
                                setVal(item)
