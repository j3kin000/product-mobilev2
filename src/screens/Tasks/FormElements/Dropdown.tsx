                ...
                <View>
                    {
                        items.map((item, index) => {
                            return (
                                <TouchableOpacity style={styles.singleItem} onPress={() => {
                                    setSelectedItem(item.key)
                                    handleElementField(key, item.key, true)
                                    setExpand(false)
                                }}><Text style={isRtl ? styles.textOptionRtl : styles.textOption}>{item.value}</Text>
                                </TouchableOpacity>)
                        })
                    }
                    <Image style={isRtl ? styles.arrowRtl : styles.arrow} source={require('../../../assets/up-arrow.png')} />
                </View>
                :
                <View>
                    <TouchableOpacity style={styles.notExpanded} onPress={() => {
                        ...
                        <Text style={isRtl ? styles.textOptionRtl : styles.textOption}>{items.find((option) => {
                            return option.key == selectedItem
                        })?.value}</Text>
                    </TouchableOpacity>
                    <Image style={isRtl ? styles.arrowRtl : styles.arrow} source={require('../../../assets/down-arrow.png')} />
                </View>
            }
        </View>
    )
